...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8 px-4 md:px-8">
    ...
    <div class="max-w-4xl mx-auto mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-900 mb-2">
            <i class="fas fa-layer-group text-indigo-600 mr-2"></i>Tambah Koleksi Baru
        </h1>
        <p class="text-gray-600">Buat koleksi produk yang baru dan menarik</p>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               name="name" 
                               value="{{ old('name') }}"
                               placeholder="Contoh: Summer Collection, New Arrivals"
                               required>
                        @error('name')
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    <label for="icon" class="block text-sm font-semibold text-gray-700 mb-3">
                        <i class="fas fa-upload text-purple-600 mr-2"></i>Upload Icon/Gambar
                    </label>
                    ...
                    <div id="iconPreview" class="mt-4 hidden">
                        <p class="text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-image text-purple-600 mr-2"></i>Preview Icon
                        </p>
